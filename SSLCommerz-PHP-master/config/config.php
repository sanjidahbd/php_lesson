...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/sanjida_ritu/SSLCommerz-PHP-master'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'schoo694f54f91cb2c'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'schoo694f54f91cb2c@ssl'); // your store password.
}
